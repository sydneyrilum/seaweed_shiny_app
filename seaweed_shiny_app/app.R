...
server <- function(input, output) {
    ...
    output$text <- renderText({
      if(input$pick_species == 1){
        "Part of the family Gracilariaceae, Gracilaria tikvahiae is native to the Long Island Sound and Newfoundland coasts (worms gracilaria). G. tikvahiae also less heavily populates areas in the North Pacific Ocean, the Northwest Atlantic Ocean, the Gulf of Maine, and was introduced to Hawaii. G. tikvahiae also has a population in the Gulf of Mexico, allowing the species to be one of the two main seaweed species observed in this study (worms gracilaria). Through information collected in the study, it was found that the dry weight of Nitrogen (N) in G. tikvahiae is 3.9% while the dry weight of Phosphorus (P) is 0.04%  (racine). This species is often found in shallow sublittoral and sheltered waters at depths of two to five meters (worms gracilaria, gorman) and can be rather sensitive to temperature shifts, more so than G. tikvahiae’s Korea-native relative G. vermiculophylla (Gorman). The abiotic restrictions used to measure suitable areas for seaweed aquaculture using the two study species included sea temperature and salinity. For G. tikvahiae this meant that temperature range must be within 15 – 34℃ and the salinity must be within 8 – 60 PSU (Practical Salinity Unit)."
      }
      else
        if(input$pick_species == 2){
          "Sargassum spp is a group of seaweed species belonging to the Sargassaceae family of seaweed (worms sargassum). This group of seaweed is known to attract an array of aquatic and semi-aquatic organisms, allowing for high biodiversity and productivity. Sargassum spp is able to provide habitats for fish, shrimp, crabs, birds, and turtles (worms sargassum). This group of seaweed resides in seamounts and knolls around the Mediterranean Sea, Republic of Mauritius, Northern European Seas, and, more relevant for this study, the Gulf of Mexico (worms sargassum). Sargassum spp is the second seaweed species observed in this study and has dry N and P weights of 2.5% and 0.3% respectively. For the abiotic restrictions, a suitable habitat for Sargassum spp must be within 18 – 30℃ and salinity within 24 – 42 PSU. Sargassum spp can also be found floating in the Sargasso Sea (named after the seaweed itself) where S. fluitans and S. natans are found to be the most abundant (wang). With the study period set between 2010 and 2012, it is important to note the first massive Sargassum spp bloom which occurred in 2011 in central Atlantic reaching all the way to the Gulf of Mexico (wang). Suitable sea temperatures and an influx of nutrient from upwelling in 2010 allowed for this bloom to come about (wang)."
        }
      else
        if(input$pick_species == 3){
          "Following the Gulf of Mexico study, the team of Bren School of Environmental Science researchers plan to explore the potential for Eucheuma spp as another seaweed bio-extractor. Eucheuma spp is part of the Solieriaceae family and is found in Brazil, Djibouti, and Venezuela (worms Eucheuma). What is interesting about Eucheuma is that it is an alien species in all of these areas and acts as more of a commercial crop (worms Eucheuma). For the abiotic restrictions, Eucheuma spp must grow in habitats of 25 – 30℃ for sea surface temperature and 28 – 34 PSU for salinity to maintain acceptable levels of suitability."
        }
      else
        if(input$pick_species == 4){
          "Ulva spp is a group of seaweed in the Ulvacae family, and although not an observed species in the Gulf of Mexico study, it is a relevant species for discussing the potential for the increase in seaweed aquaculture and is often addressed in the study. In particular the Ulva prolifera algal bloom from 2008 – 2012 in the Yellow Sea near Qingdao, the world’s largest trans-regional macroalgal bloom, was referenced on multiple occasions throughout the Gulf of Mexico paper (hiraoka) . Ulva spp including U. prolifera is a highly widespread group of seaweed and is found in a large percentage of Earth’s marine ecosystems. Seaweed farming associated with the species has been known to help stabilize eutrophication in coastal China."
        }
    })
